                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-header border-bottom pb-0">
                                <div class="d-sm-flex align-items-center">
                                    <div>
                                        <h6 class="font-weight-semibold text-lg mb-0">Lista de Funcionários</h6>
                                    </div>
                                    <div class="ms-auto d-flex">
                                        <button type="button"
                                            ...
                                            <span class="btn-inner--text">Adicionar Funcionários</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="p-0 modal-body">
                                            <div class="card card-plain">
                                                <div class="pb-0 text-left card-header">
                                                    ...
                                                    <p class="mb-0">Cadastro de funcionários</p>
                                                </div>
                                                <div class="pb-3 card-body">
                                                    <form method="post" action="{{ route('funcionarios.cadastro') }}">
                                                        @csrf
                                                        <label>Nome</label>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            <input type="date" name="data_contratacao"
                                                                class="form-control" placeholder="Data da Contratação">
                                                        </div>
                                                        <label>Salário Bruto</label>
                                                        <div class="mb-3">
                                                            <input type="number" name="salario_bruto"
                                                                class="form-control" placeholder="Salário Bruto"
                                                                step="0.01" required>
                                                        </div>
                                                        <label>Função</label>
                                                        <div class="mb-3">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Função</th>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div class="d-flex flex-column justify-content-center ms-1">
                                            <h6 class="mb-0 text-sm font-weight-semibold">{{ $funcionario->nome }}</h6>
                                        </div>

                                    </div>
                                </td>
                                <td>
                                    <p class="text-sm text-dark font-weight-semibold mb-0">{{ $funcionario->funcao }}</p>
                                </td>
