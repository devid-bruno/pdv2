                                            ...
                                            <li class="nav-item ps-2 d-flex align-items-center">
                                                <div class="dropdown text-end">
                                                    ...
                                                    <ul class="dropdown-menu text-small">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('logout') }}">Sign
                                                                out</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                        ...
                                        <div class="card border shadow-xs mb-4">
                                            ...
                                            <div class="card-body px-0 py-0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex px-2">
                                                                        <div class="my-auto">
                                                                            <h6 class="mb-0 text-sm">{{ $pedido->numero_pedido }}</h6>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                  ...
                                                                                  <br>
                                                                                  Status Pagamento: <strong>{{ $pedido->status->status }}</strong>
                                                                                </div>
                                                ...
                                                <div class="border-top py-3 px-3 d-flex align-items-center">
                                                    <button
                                                        class="btn btn-sm btn-white d-sm-block d-none mb-0">Previous</button>
                                                    ...
                                                    <button
                                                        class="btn btn-sm btn-white d-sm-block d-none mb-0 ms-auto">Next</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
